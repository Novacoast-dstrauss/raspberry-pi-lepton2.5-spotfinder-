...
# Generated by qmake (2.01a) (Qt 4.8.2) on: Thu Jul 14 04:15:19 2016
# Project:  raspberrypi_video.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile raspberrypi_video.pro
#############################################################################
...
LINK          = g++
LFLAGS        = -Wl,-O1
LIBS          = $(SUBLIBS)  -L/usr/lib/arm-linux-gnueabihf -L../raspberrypi_libs/leptonSDKEmb32PUB/Debug -lLEPTON_SDK -lQtGui -lQtCore -lpthread 
AR            = ar cqs
RANLIB        = 
QMAKE         = /usr/bin/qmake
TAR           = tar -cf
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) gen_objs/raspberrypi_video1.0.0/ && $(COPY_FILE) --parents Lepton_I2C.h LeptonThread.h MyLabel.h OutlineLabel.h Palettes.h SPI.h gen_objs/raspberrypi_video1.0.0/ && $(COPY_FILE) --parents Lepton_I2C.cpp LeptonThread.cpp main.cpp MyLabel.cpp OutlineLabel.cpp Palettes.cpp SPI.cpp gen_objs/raspberrypi_video1.0.0/ && (cd `dirname gen_objs/raspberrypi_video1.0.0` && $(TAR) raspberrypi_video1.0.0.tar raspberrypi_video1.0.0 && $(COMPRESS) raspberrypi_video1.0.0.tar) && $(MOVE) `dirname gen_objs/raspberrypi_video1.0.0`/raspberrypi_video1.0.0.tar.gz . && $(DEL_FILE) -r gen_objs/raspberrypi_video1.0.0
...
compiler_moc_header_make_all: gen_mocs/moc_LeptonThread.cpp gen_mocs/moc_MyLabel.cpp gen_mocs/moc_OutlineLabel.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) gen_mocs/moc_LeptonThread.cpp gen_mocs/moc_MyLabel.cpp gen_mocs/moc_OutlineLabel.cpp
gen_mocs/moc_LeptonThread.cpp: LeptonThread.h
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) LeptonThread.h -o gen_mocs/moc_LeptonThread.cpp

gen_mocs/moc_MyLabel.cpp: MyLabel.h
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) MyLabel.h -o gen_mocs/moc_MyLabel.cpp

gen_mocs/moc_OutlineLabel.cpp: OutlineLabel.h
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) OutlineLabel.h -o gen_mocs/moc_OutlineLabel.cpp
...
gen_objs/OutlineLabel.o: OutlineLabel.cpp OutlineLabel.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o gen_objs/OutlineLabel.o OutlineLabel.cpp
...
gen_objs/moc_OutlineLabel.o: gen_mocs/moc_OutlineLabel.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o gen_objs/moc_OutlineLabel.o gen_mocs/moc_OutlineLabel.cpp
